...
- ИзмеИзменен процесс обновления опыта и уровня собак 

## [3.4.1] - 06.06.2024

### Добавлено
- Добавлен аргумент `--without-threads`, чтобы запускать бота без потоков (нужен для отладки)
- Конвертация типов в ожыдаемие типы (если это возможно) в классе `BaseModel`
...
- Команда `/exchanger` не времено отключена из изза бага [#18](https://github.com/HamletSargsyan/livebot/issues/18)
